...
export default {
    ...
    data(){
        return{
            ...
            spesialis:[],
            data: {
            id_dokter: this.dataDokter.id_dokter,
            nama_dokter: this.dataDokter.nama_dokter,
            jenis_kelamin: this.dataDokter.jenis_kelamin,
            telphone: this.dataDokter.telphone,
            alamat: this.dataDokter.alamat,
            id_spesialis: null,
        },
        }
    },
    methods: {
      ...
      editDokter(){
        axios.put('http://localhost/phprest/api/dokter/update.php', JSON.stringify(this.data))
        .then(response => {
